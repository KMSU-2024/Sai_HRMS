page 33065491 "CrossCompanyEmployeeHist" //SS03NOV

{
...

    {
...

        {
...

            {
                ...
                field("Bill Group"; Rec."Bill Group") { ApplicationArea = All; }

                field("Bill Type"; Rec."Bill Type") { ApplicationArea = All; }

                field("Account Type"; Rec."Account Type") { ApplicationArea = All; }

                field("Designation as per HRMS Site"; Rec."Designation as per HRMS Site") { ApplicationArea = All; }

                field("Designation"; Rec."Designation") { ApplicationArea = All; }

                field("Dept./Trade/Section"; Rec."Dept./Trade/Section") { ApplicationArea = All; }

                field("Post Group"; Rec."Post Group") { ApplicationArea = All; }

                field("GPF/PRAN No"; Rec."GPF/PRAN No") { ApplicationArea = All; }

                field("Birth Date"; Rec."Birth Date") { ApplicationArea = All; }

                field("Gender"; Rec."Gender") { ApplicationArea = All; }

                field("D.O.S (Date of Superannuation)"; Rec."D.O.S (Date of Superannuation)") { ApplicationArea = All; }

                field("Category"; Rec."Category") { ApplicationArea = All; }

                field("Joining Station"; Rec."Joining Station") { ApplicationArea = All; }

                field("D.O.J (Service)"; Rec."D.O.J (Service)") { ApplicationArea = All; }

                field("Current Station"; Rec."Current Station") { ApplicationArea = All; }

                field("Service Joining Designation"; Rec."Service Joining Designation") { ApplicationArea = All; }

                field("Base Qualification"; Rec."Base Qualification") { ApplicationArea = All; }

                field("Home Dist as per HRMS Site"; Rec."Home Dist as per HRMS Site") { ApplicationArea = All; }

                field("Home Dist"; Rec."Home Dist") { ApplicationArea = All; }

                field("Basic Gr. Pay"; Rec."Basic Gr. Pay") { ApplicationArea = All; }

                field("Employment Status"; Rec."Employment Status") { ApplicationArea = All; }

                field("Date of increment"; Rec."Date of increment") { ApplicationArea = All; }

                field("Email"; Rec."Email") { ApplicationArea = All; }

                field("EPIC No"; Rec."EPIC No") { ApplicationArea = All; }

                field("MACP Status"; Rec."MACP Status") { ApplicationArea = All; }

                field("Mobile Phone No."; Rec."Mobile Phone No.") { ApplicationArea = All; }

                field("Pension Remark"; Rec."Pension Remark") { ApplicationArea = All; }

                field("Status"; Rec."Status") { ApplicationArea = All; }

                field("SLCM Employee"; Rec."SLCM Employee") { ApplicationArea = All; }

                field("Deployment Location"; Rec."Deployment Location") { ApplicationArea = All; }

                field("Deployment Start Date"; Rec."Deployment Start Date") { ApplicationArea = All; }

                field("Deployment Start Date1"; Rec."Deployment Start Date") { ApplicationArea = All; }

                field("Deployment End Date"; Rec."Deployment End Date") { ApplicationArea = All; }
    ...
    var
        ...
        EmpHistMgt: Codeunit "Training Buffer Mgt";

    procedure LoadData(HRMSID: Code[20])

    begin

        EmpHistMgt.LoadEmployeeHistoryAcrossCompanies(HRMSID);
...
/* page 50110 "CrossCompanyEmployeeHist"//SS07OCT
