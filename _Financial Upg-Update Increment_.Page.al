...

        {
...

            {
...

                {
                    ...
                    field("Date of application upload"; rec."Date of application upload") { ApplicationArea = All; }

                    field("IsConfirmed"; rec."IsConfirmed") { ApplicationArea = All; } //ss16oct
...

        {
...

            {
                ...
                begin
                    ...
                    //  rec.TestField("Type of increment");
                    ...
                    if Rec."Entry No." = 0 then begin
                        ...
                        rec."Date of application upload" := CurrentDateTime; //ss16oct
                    ...
                    if Rec."Status" <> Rec.Status::Processed then begin
                        ...
                        hist.Status := Rec.Status::Processed;
                        ...
                        hist."Date of application upload" := CurrentDateTime; //ss16oct
...

            {
                ...
                begin
                    ...
                    DownloadFromStream(
                                             TempBlob,
                                             'Save Application File',      // Dialog Title
