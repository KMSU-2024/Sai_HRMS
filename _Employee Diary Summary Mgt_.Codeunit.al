codeunit 33065489 "Employee Diary Summary Mgt"
{
    ...
    local procedure LoadEmployeesAcrossCompanies(HRMS: Code[20])
    var
    ...
    procedure LoadEmpHistData(HRMSID: Code[20])
    var
    ...
    procedure LoadFinancialUpgHistData(HRMSID: Code[20])
    var
        LineNo: Integer;
    ...
    begin
        ...
        if CompanyRec.FindSet() then
            ...
            until CompanyRec.Next() = 0;
        IF FinUpgHistTemp.FindLast() THEN
            Message('Count of Records %1', LineNo);
        Commit();
    end;
    ...
    var
        HistPage: Page CrossCompanyFinancialUpgHist;
