page 33066441 "Annual Establishment(Part-A)"
{
    ...
    actions
    {
        area(Processing)
        {
            action("Submit")
            {
                ...
                trigger OnAction()
                var
                    AnnualEstabRevieRec: Record "Annual Establishment Review";
                begin
    ...
    var
        EstablType: Option " ","Part – A (Regular Establishment)","Part – C (Non-regular Establishment)","Part – E (Outsourced/ on contract)";
