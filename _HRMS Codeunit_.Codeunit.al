codeunit 33066459 "HRMS Codeunit"
{
    ...
    procedure HRMSDataImportFromGovtPortal(FileName: Text[250])
    var
        EmployeeDataImport: xmlport "Employee Data Import";
    ...
    procedure ExportEmployeeList(): Text[250]
    var
    ...
    procedure ExportFinancialUpgradationApplicationForm(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportPromotionDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportAnnualEstablishmentPartA(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportAnnualEstablishmentPartC(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportAnnualEstablishmentPartE(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportTransferConsolidatedList(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportStaffAchivementDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportDisciplinaryDetailsPreview(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportEmployeeTrainingDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportAnnualIncrementDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportAnnualInternalPerformance(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportCourtCaseMonitoringDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    procedure ExportRTIMonitoringDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        FileName1: Text[250];
    begin
    ...
    filenamePar: Text[200])
    var
        EmpTrainHistRec: Record "Employee Training History";
    begin
  ...
  */
    procedure submitDisciplinaryCaseDetails(HRMSID: code[20]; Name: Text[100]; Designation: code[20]; fileName: Text[200]; DisciplinaryCaseLetterNo: Text[50]; DisciplinaryCaseDate: Date; DisciplinaryCaseStatus: Enum "Discipinary CaseStatus"; WhetherPlacedUnderSuspension: Boolean; WhetherReinstated: Boolean; VigilanceCasePending: Boolean)
    var
    ...
    procedure SubmitDisciplinaryCase(HRMSID: code[20]; Name: Text[100]; Designation: code[20]; fileName: Text[200]; DisciplinaryCaseLetterNo: Text[50]; DisciplinaryCaseDate: Date; DisciplinaryCaseStatus: Enum "Discipinary CaseStatus"; WhetherPlacedUnderSuspension: Boolean; WhetherReinstated: Boolean; VigilanceCasePending: Boolean)
    var
        DisciplinaryCaseInputPage: Page "Disciplinary Case Input";
        disciplinaryHist: Record "Disciplinary History";
        outs: OutStream;
    ...
    procedure submitAnnualPerformanceDetails(HRMSID: code[20]; Name: Text[100]; Designation: code[20]; PerformanceYear: Integer; PerformanceRating: Option "Submitted","Reported","Reviewed","Forwarded","Accepted"; Department: code[20]; AcademicYaer: Text[20]; AcademicYear: Text[20])
    var
    ...
    procedure DownloadDisciplinaryChargeDoc(HRMSID: code[20]): Text[200]
    var
        EmpTrainHistRec: Record "Disciplinary History";
    begin
        EmpTrainHistRec.Get(HRMSID);
    ...
    //megha end
    procedure "Download Employee Training History Certificate"(Entrynopar: Integer): Text[200]
    var
        EmpTrainHistRec: Record "Employee Training History";
    begin
        EmpTrainHistRec.Get(Entrynopar);
    ...
    procedure "Download Room Wise Details"(Entrynopar: Code[20]): Text[200]
    var
        EmpTrainHistRec: Record "Room Wise Details";
    begin
        EmpTrainHistRec.Get(Entrynopar);
        exit(EmpTrainHistRec."Uploaded File Name ");
    end;

    procedure "Download Room Wise Details Hist"(Entrynopar: Code[20]): Text[200]
    var
        EmpTrainHistRec: Record "Room Wise Details History";
    begin
        EmpTrainHistRec.Get(Entrynopar);
        exit(EmpTrainHistRec."Uploaded File Name ");
    end;

    procedure SubmitRoomWiseDetails(
     EntryNo: Code[20];
     ...
     TypeOfWallFan: Option
 )
    var
        RoomWiseDet: Record "Room Wise Details";
    ...
    filenamePar: Text[200])
    var
        Emptransfer: Record "Transfer Application Employee";
    begin
    ...
    filenamePar: Text[200])
    var
        StaffAchive: Record "Staff Achivement History";
    begin
    ...
    procedure "Download Staff Achivement"(SLnopar: Integer): Text[200]
    var
        StaffAchive: Record "Staff Achivement History";
    begin
    ...
    filenamePar: Text[200])
    var
        PromotionHistRec: Record "Employee Promotion History";
    begin
    ...
    procedure "Download Promotion Order"(ENTnopar: Integer): Text[200]
    var
        PromotionHistRec: Record "Employee Promotion History";
    begin
        PromotionHistRec.Get(ENTnopar);
    ...
    filenamePar: Text[200])
    var
        TransferHistRec: Record "Transfer Joining History";
    begin
        TransferHistRec.Get(ENTnopar);
        TransferHistRec."Transfer Order File Name" := filenamePar;
    end;

    procedure "Download Transfer Order"(ENTnopar: Integer): Text[200]
    var
        TransferHistRec: Record "Transfer Joining History";
    begin
        TransferHistRec.Get(ENTnopar);
    ...
    filenamePar: Text[200])
    var
        FinUpAppRECRec: Record "Financial Upg Application";
    begin
    ...
    procedure ExportDTETEmployeeList(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
    ...
    procedure ExportDTETTransferDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETPromotionDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETStaffProfileDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETAnnualEstablishmentPartA(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETAnnualEstablishmentPartC(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETAnnualEstablishmentPartE(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETAnnualPerformanceDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETEmployeeTransferApplicationDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure ExportDTETFinancialUpgradationDetails(): Text[250]
    var
        GeneralLedgerSetup: Record "General Ledger Setup";
        DTETServiceMonitoring: Report "DTET Service Monitoring";
        FileName1: Text[250];
    ...
    procedure UpdateAddEmpDetails(HRMSID: code[20])
    var
        EmpAddDtls: Record "Employee Additional Info";
        emp: Record Employee;
    begin
        EmpAddDtls.Reset();
    ...
    EmpStatus: Option " ","Ad hoc","Temporary status","Initial appointee","Regular")
    var
        EmpAddDtls: Record "Employee Additional Info";
        emp: Record Employee;
    begin
    ...
    //     end;
    // end;
    procedure EmployeeRelief(EntryNo: Integer)
    var
    ...
    HRMSID: Code[20])
    var
        EmployeeLocVar: Record Employee;
        EmployeeRec: Record Employee;
