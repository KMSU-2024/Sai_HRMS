table 33065968 "Financial Upg Application"
{
        ...
        field(1; "HRMS ID"; Code[20])
        {
            ...
            begin
                if EmplRec.Get("HRMS ID") then begin
                    ...
                    "Current Station" := EmplRec."Current Station";//ssnov20
                end
            end;
        }
    ...
    begin
        ...
        // If status changes from non-Processed to Processed, archive a history version. //ssnov20  
        ...
        // if OldRec."Status" = OldRec.Status::Processed then Error('This increment (Entry No. %1) is already Confirmed/Processed. Create a new version instead.', OldRec."Entry No."); //ssnov20
    ...
    begin
        ...
        // ArchiveFinUpgTab."Date of application upload":=Rec."Date of application upload";
         ...
         ArchiveFinUpgTab."Type of increment":=Format(Rec."Type of increment");//ss18nov
         //ArchiveFinUpgTab.TransferFields(Rec)
         ArchiveFinUpgTab.Sl_no:=entrno;
         ArchiveFinUpgTab.Insert(true);*/
    end;
